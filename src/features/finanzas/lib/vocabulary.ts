...
export const KIND_WORDS: ReadonlySet<string> = new Set(KIND_PHRASES.flatMap((p) => p.seq));
...
export const MERCHANTS: Record<string, Category> = {
  ...
  bbva: 'transferencia',
  lulo: 'transferencia',
  nubank: 'transferencia',
  dale: 'transferencia',
  uala: 'transferencia',
  cajero: 'transferencia',
  corresponsal: 'transferencia',
  cuota: 'otros',
  dmf: 'otros',
  rtf: 'otros',
  ...
  playstore: 'entretenimiento',
  primevideo: 'entretenimiento',
...
const KEYWORDS_BY_CATEGORY: Record<Category, readonly string[]> = {
  ...
  transferencia: ['transferencia', 'giro', 'envio', 'retiro', 'cajero', 'consignacion', 'prestamo'],
